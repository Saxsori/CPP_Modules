...
/*   Updated: 2022/10/09 20:54:18 by aaljaber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << BPUR << "ClapTrap default Constructor called" << DEFCOLO << std::endl;
}
...
{
	std::cout << BBLU << "ClapTrap Destructor called" << DEFCOLO << std::endl;
}
